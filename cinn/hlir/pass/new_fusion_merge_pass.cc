...
void NewFusionMergePassInternal(Graph* graph) {
...
CINN_REGISTER_HELPER(NewFusionMergePass) {
  CINN_REGISTER_PASS(NewFusionMergePass)
      .describe(
          "Fusion Merge Pass which performs Fusion-Ops fusion, Producer Fusion-Ops are fused into Consumer Fusion-Ops "
          "with certain conditions.")
      .set_change_structure(false)
      .set_body(cinn::hlir::pass::NewFusionMergePassInternal);
